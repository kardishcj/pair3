...
anes_boomer <- subset(anes_dta, anes_dta$dem_age_r_x > 47 & anes_dta$dem_age_r_x < 67) #creates Baby Boomer subset
anes_silent <- subset(anes_dta, anes_dta$dem_age_r_x > 66 & anes_dta$dem_age_r_x < 88) #creates Silent Generation subset
