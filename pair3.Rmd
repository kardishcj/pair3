...
ggplot(race_genY, aes(x = race_genY[,1], y = race_genY[,2])) + geom_bar(stat = "identity") + ggtitle("Gen Y Race") + labs(x="Race",y="Number of people")


```


Now, we'll take a look at the babyboomers breakdown by race. 
...
ggplot(race_boomer, aes(x = race_boomer[,1], y = race_boomer[,2])) + geom_bar(stat = "identity") + ggtitle("Boomer Race") + labs(x="Race",y="Number of people")
