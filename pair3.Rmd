...
ggplot(ed_genY, aes(x = ed[,1], y = ed[,2])) + geom_bar(stat = "identity") + ggtitle("Gen Y Education") + labs(x="Education",y="Number of people")
...
ggplot(ed_boomer, aes(x = ed[,1], y = ed[,2])) + geom_bar(stat = "identity") + ggtitle("Boomer Education") + labs(x="Education",y="Number of people")
...
```{r}
#Looking at the breakdown of race for GenerationY
...
ggplot(race_genY, aes(x = ed[,1], y = ed[,2])) + geom_bar(stat = "identity") + ggtitle("Gen Y Race") + labs(x="Race",y="Number of people")
...
ggplot(race_boomer, aes(x = ed[,1], y = ed[,2])) + geom_bar(stat = "identity") + ggtitle("Boomer Race") + labs(x="Race",y="Number of people")
