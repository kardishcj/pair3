...
levels(anes$pid_strong) <- c("Refused", "Don't know", "Inapplicable", "Very strongly", "Moderately strongly", "A little strongly") 
...
stargazer(emp_genY, emp_boomer, summary = FALSE, rownames = FALSE, title = c("Millennial Employment Breakdown", "Boomer Employment Breakdown"))
```
...
ggplot(pid_boomer, aes(x = pid_boomer[,1], y = pid_boomer[,2])) + geom_bar(stat = "identity") + ggtitle("Boomer Party ID Strength") + labs(x="Strength of Party ID", y="Number of people")
```
...
Whether a respondent voted in the 2008 presidential election is coded either as "refusedâ," "don't know," "yes", or "no," with the vast majority of respondents saying they did indeed vote. 
